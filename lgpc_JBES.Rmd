...
(\#eq:lgdeapprox)
\end{equation}  
where, as in Otneim and Tjøstheim [-@otneim2017locally; -@otneim2017conditional] in a further simplified representation, we have fixed local means and standard deviations $\mu_j(\z) = 0$ and $\sigma_j^2(\z) = 1$, $j = 1,\ldots,p$, and where $\R(\z) = \{\rho_{jk}(\z)\}$ is the *local correlation matrix*.
...
**Acknowledgements.** The authors gratefully acknowledge the input of an associate editor as well as two anonymuos referees, whose comments have greatly improved this paper.
