...
\end{equation}
and where the latter expression is defined analogously to \@ref(eq:matrixlocalpartial). The conditional density $f_{Z_2|\Z_3}(z_2|\z_3)$ is defined in the same way. If $Z_1$ and $Z_2$ are conditionally independent given $\Z_3$, then, by definition, 
